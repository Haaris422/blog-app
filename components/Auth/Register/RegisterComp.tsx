...
export function RegisterComp() {
  ...
  const [state, action, isPending] = useActionState<FormState, FormData>(signup, {});
  ...
  return (
    <div>
      ...
      <h2 className="text-center ">Already have an account? <Link className={`${animationCalss} hover:underline hover:opacity-60`} href={'/login'}>Login</Link></h2>
